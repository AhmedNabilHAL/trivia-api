...
This project is a trivia game where users can challenge their knowledge answering trivia questions. The backend API has the following functionality:
...
This endpoint searches for questions given a search term

* General
  * Searches using a JSON search parameter called "search".
  * Returns all questions matching the search term.
...
Ahmed Nabil authored the API (`__init__.py`), test suite (`test_flaskr.py`), This readme file was written with help from Alex Sandberg-Bernard.<br>
All other project files, including the models and frontend, were created by [Udacity](https://www.udacity.com/) as a project template.